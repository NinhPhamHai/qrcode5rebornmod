...
.method public createTrack(Landroid/media/MediaFormat;)Landroidx/media2/player/subtitle/SubtitleTrack;
    ...
    .line 73
    iget-object v0, p0, Landroidx/media2/player/subtitle/ClosedCaptionRenderer;->mCCWidget:Landroidx/media2/player/subtitle/ClosedCaptionRenderer$Cea608CCWidget;

    if-nez v0, :cond_0

    .line 74
    new-instance v0, Landroidx/media2/player/subtitle/ClosedCaptionRenderer$Cea608CCWidget;

    iget-object v1, p0, Landroidx/media2/player/subtitle/ClosedCaptionRenderer;->mContext:Landroid/content/Context;

    invoke-direct {v0, p0, v1}, Landroidx/media2/player/subtitle/ClosedCaptionRenderer$Cea608CCWidget;-><init>(Landroidx/media2/player/subtitle/ClosedCaptionRenderer;Landroid/content/Context;)V

    iput-object v0, p0, Landroidx/media2/player/subtitle/ClosedCaptionRenderer;->mCCWidget:Landroidx/media2/player/subtitle/ClosedCaptionRenderer$Cea608CCWidget;

    .line 76
    :cond_0
    new-instance v0, Landroidx/media2/player/subtitle/ClosedCaptionRenderer$Cea608CaptionTrack;
    ...
    invoke-direct {v0, v1, p1}, Landroidx/media2/player/subtitle/ClosedCaptionRenderer$Cea608CaptionTrack;-><init>(Landroidx/media2/player/subtitle/ClosedCaptionRenderer$Cea608CCWidget;Landroid/media/MediaFormat;)V
