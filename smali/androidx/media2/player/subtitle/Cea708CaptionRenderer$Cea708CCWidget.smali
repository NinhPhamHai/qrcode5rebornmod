...
.method constructor <init>(Landroidx/media2/player/subtitle/Cea708CaptionRenderer;Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    .line 134
    new-instance p1, Landroidx/media2/player/subtitle/Cea708CaptionRenderer$Cea708CCWidget$CCHandler;

    iget-object p2, p0, Landroidx/media2/player/subtitle/Cea708CaptionRenderer$Cea708CCWidget;->mClosedCaptionLayout:Landroidx/media2/player/subtitle/ClosedCaptionWidget$ClosedCaptionLayout;

    check-cast p2, Landroidx/media2/player/subtitle/Cea708CaptionRenderer$Cea708CCWidget$CCLayout;

    invoke-direct {p1, p0, p2}, Landroidx/media2/player/subtitle/Cea708CaptionRenderer$Cea708CCWidget$CCHandler;-><init>(Landroidx/media2/player/subtitle/Cea708CaptionRenderer$Cea708CCWidget;Landroidx/media2/player/subtitle/Cea708CaptionRenderer$Cea708CCWidget$CCLayout;)V

    iput-object p1, p0, Landroidx/media2/player/subtitle/Cea708CaptionRenderer$Cea708CCWidget;->mCCHandler:Landroidx/media2/player/subtitle/Cea708CaptionRenderer$Cea708CCWidget$CCHandler;
...
.method public emitEvent(Landroidx/media2/player/subtitle/Cea708CCParser$CaptionEvent;)V
    ...
    invoke-virtual {p0, p1, v0}, Landroidx/media2/player/subtitle/Cea708CaptionRenderer$Cea708CCWidget;->setSize(II)V

    .line 148
    iget-object p1, p0, Landroidx/media2/player/subtitle/Cea708CaptionRenderer$Cea708CCWidget;->mListener:Landroidx/media2/player/subtitle/SubtitleTrack$RenderingWidget$OnChangedListener;
