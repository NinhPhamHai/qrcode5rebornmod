...
.method private handleCtrlCode(Landroidx/media2/player/subtitle/Cea608CCParser$CCData;)Z
    ...
    .line 188
    iget v0, p0, Landroidx/media2/player/subtitle/Cea608CCParser;->mPrevCtrlCode:I
    ...
    .line 190
    iput v2, p0, Landroidx/media2/player/subtitle/Cea608CCParser;->mPrevCtrlCode:I
    ...
    .line 254
    iput v3, p0, Landroidx/media2/player/subtitle/Cea608CCParser;->mMode:I
    ...
    invoke-virtual {v0}, Landroidx/media2/player/subtitle/Cea608CCParser$CCMemory;->erase()V
    ...
    iget v2, p0, Landroidx/media2/player/subtitle/Cea608CCParser;->mRollUpSize:I

    invoke-virtual {v0, v2}, Landroidx/media2/player/subtitle/Cea608CCParser$CCMemory;->rollUp(I)V
    ...
    invoke-virtual {v0}, Landroidx/media2/player/subtitle/Cea608CCParser$CCMemory;->cr()V
    ...
    invoke-virtual {v0}, Landroidx/media2/player/subtitle/Cea608CCParser$CCMemory;->der()V
    ...
    :cond_3
    :goto_1
    iput p1, p0, Landroidx/media2/player/subtitle/Cea608CCParser;->mPrevCtrlCode:I
...
.method private handleDisplayableChars(Landroidx/media2/player/subtitle/Cea608CCParser$CCData;)Z
    ...
    invoke-virtual {v0, p1}, Landroidx/media2/player/subtitle/Cea608CCParser$CCMemory;->writeText(Ljava/lang/String;)V

    .line 144
    iget p1, p0, Landroidx/media2/player/subtitle/Cea608CCParser;->mMode:I
...
.method private handleMidRowCode(Landroidx/media2/player/subtitle/Cea608CCParser$CCData;)Z
    ...
    invoke-virtual {v0, p1}, Landroidx/media2/player/subtitle/Cea608CCParser$CCMemory;->writeMidRowCode(Landroidx/media2/player/subtitle/Cea608CCParser$StyleCode;)V
...
.method private handlePACCode(Landroidx/media2/player/subtitle/Cea608CCParser$CCData;)Z
    ...
    invoke-virtual {v0, v1, v2}, Landroidx/media2/player/subtitle/Cea608CCParser$CCMemory;->moveBaselineTo(II)V
    ...
    invoke-virtual {v0, p1}, Landroidx/media2/player/subtitle/Cea608CCParser$CCMemory;->writePAC(Landroidx/media2/player/subtitle/Cea608CCParser$PAC;)V
...
.method private handleTabOffsets(Landroidx/media2/player/subtitle/Cea608CCParser$CCData;)Z
    ...
    invoke-virtual {v0, p1}, Landroidx/media2/player/subtitle/Cea608CCParser$CCMemory;->tab(I)V
...
.method private updateDisplay()V
    ...
    invoke-interface {v1, v0}, Landroidx/media2/player/subtitle/Cea608CCParser$DisplayListener;->onDisplayChanged([Landroid/text/SpannableStringBuilder;)V
...
.method public parse([B)V
    ...
    .line 94
    sget-boolean v1, Landroidx/media2/player/subtitle/Cea608CCParser;->DEBUG:Z
    ...
    invoke-virtual {v1}, Landroidx/media2/player/subtitle/Cea608CCParser$CCData;->toString()Ljava/lang/String;
    ...
    invoke-direct {p0, v1}, Landroidx/media2/player/subtitle/Cea608CCParser;->handleCtrlCode(Landroidx/media2/player/subtitle/Cea608CCParser$CCData;)Z
    ...
    .line 99
    invoke-direct {p0, v1}, Landroidx/media2/player/subtitle/Cea608CCParser;->handleTabOffsets(Landroidx/media2/player/subtitle/Cea608CCParser$CCData;)Z
    ...
    .line 100
    invoke-direct {p0, v1}, Landroidx/media2/player/subtitle/Cea608CCParser;->handlePACCode(Landroidx/media2/player/subtitle/Cea608CCParser$CCData;)Z
    ...
    .line 101
    invoke-direct {p0, v1}, Landroidx/media2/player/subtitle/Cea608CCParser;->handleMidRowCode(Landroidx/media2/player/subtitle/Cea608CCParser$CCData;)Z
    ...
    invoke-direct {p0, v1}, Landroidx/media2/player/subtitle/Cea608CCParser;->handleDisplayableChars(Landroidx/media2/player/subtitle/Cea608CCParser$CCData;)Z
