...
.method constructor <init>(Landroidx/media2/session/MediaSession;Landroid/content/Context;Ljava/lang/String;Landroidx/media2/common/SessionPlayer;Landroid/app/PendingIntent;Ljava/util/concurrent/Executor;Landroidx/media2/session/MediaSession$SessionCallback;Landroid/os/Bundle;)V
    ...
    iput-object p1, p0, Landroidx/media2/session/MediaSessionImplBase;->mPlayerCallback:Landroidx/media2/common/SessionPlayer$PlayerCallback;
    ...
    invoke-direct {p1, p0}, Landroidx/media2/session/MediaSessionLegacyStub;-><init>(Landroidx/media2/session/MediaSession$MediaSessionImpl;)V
    ...
    invoke-virtual {p1, p5}, Landroid/support/v4/media/session/MediaSessionCompat;->setSessionActivity(Landroid/app/PendingIntent;)V
    ...
    invoke-virtual {p1, p2, p3}, Landroid/support/v4/media/session/MediaSessionCompat;->setCallback(Landroid/support/v4/media/session/MediaSessionCompat$Callback;Landroid/os/Handler;)V

    .line 232
    iget-object p1, p0, Landroidx/media2/session/MediaSessionImplBase;->mSessionCompat:Landroid/support/v4/media/session/MediaSessionCompat;

    invoke-virtual {p1, p7}, Landroid/support/v4/media/session/MediaSessionCompat;->setActive(Z)V
...
.method createPlaybackInfo(Landroidx/media2/common/SessionPlayer;Landroidx/media/AudioAttributesCompat;)Landroidx/media2/session/MediaController$PlaybackInfo;
    ...
    .line 317
    invoke-direct {p0, p2}, Landroidx/media2/session/MediaSessionImplBase;->getLegacyStreamType(Landroidx/media/AudioAttributesCompat;)I
...
.method dispatchRemoteControllerTaskWithoutReturn(Landroidx/media2/session/MediaSession$ControllerInfo;Landroidx/media2/session/MediaSessionImplBase$RemoteControllerTask;)V
    ...
    invoke-interface {p2, v1, v0}, Landroidx/media2/session/MediaSessionImplBase$RemoteControllerTask;->run(Landroidx/media2/session/MediaSession$ControllerCb;I)V
    :try_end_0
    .catch Landroid/os/DeadObjectException; {:try_start_0 .. :try_end_0} :catch_1
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public updatePlayer(Landroidx/media2/common/SessionPlayer;)V
    ...
    check-cast v6, Landroidx/media2/session/RemoteSessionPlayer;

    .line 289
    new-instance p1, Landroidx/media2/session/MediaSessionImplBase$2;

    .line 290
    invoke-virtual {v6}, Landroidx/media2/session/RemoteSessionPlayer;->getVolumeControlType()I

    move-result v3

    .line 291
    invoke-virtual {v6}, Landroidx/media2/session/RemoteSessionPlayer;->getMaxVolume()I

    move-result v4

    .line 292
    invoke-virtual {v6}, Landroidx/media2/session/RemoteSessionPlayer;->getVolume()I
    ...
    invoke-direct/range {v1 .. v6}, Landroidx/media2/session/MediaSessionImplBase$2;-><init>(Landroidx/media2/session/MediaSessionImplBase;IIILandroidx/media2/session/RemoteSessionPlayer;)V

    .line 303
    iget-object v0, p0, Landroidx/media2/session/MediaSessionImplBase;->mSessionCompat:Landroid/support/v4/media/session/MediaSessionCompat;

    invoke-virtual {v0, p1}, Landroid/support/v4/media/session/MediaSessionCompat;->setPlaybackToRemote(Landroidx/media/VolumeProviderCompat;)V
    ...
    invoke-direct {p0, p1}, Landroidx/media2/session/MediaSessionImplBase;->getLegacyStreamType(Landroidx/media/AudioAttributesCompat;)I
