...
.method public final cancel(Z)Z
    ...
    invoke-virtual {v6, v0, v4, v3}, Landroidx/media2/common/futures/AbstractResolvableFuture$AtomicHelper;->casValue(Landroidx/media2/common/futures/AbstractResolvableFuture;Ljava/lang/Object;Ljava/lang/Object;)Z
    ...
    .line 576
    invoke-virtual {v0}, Landroidx/media2/common/futures/AbstractResolvableFuture;->interruptTask()V

    .line 578
    :cond_4
    invoke-static {v0}, Landroidx/media2/common/futures/AbstractResolvableFuture;->complete(Landroidx/media2/common/futures/AbstractResolvableFuture;)V

    .line 579
    instance-of v0, v4, Landroidx/media2/common/futures/AbstractResolvableFuture$SetFuture;

    if-eqz v0, :cond_9

    .line 583
    check-cast v4, Landroidx/media2/common/futures/AbstractResolvableFuture$SetFuture;

    iget-object v0, v4, Landroidx/media2/common/futures/AbstractResolvableFuture$SetFuture;->future:Lcom/google/common/util/concurrent/ListenableFuture;
...
.method protected setException(Ljava/lang/Throwable;)Z
    ...
    invoke-direct {v0, p1}, Landroidx/media2/common/futures/AbstractResolvableFuture$Failure;-><init>(Ljava/lang/Throwable;)V

    .line 712
    sget-object p1, Landroidx/media2/common/futures/AbstractResolvableFuture;->ATOMIC_HELPER:Landroidx/media2/common/futures/AbstractResolvableFuture$AtomicHelper;

    const/4 v1, 0x0

    invoke-virtual {p1, p0, v1, v0}, Landroidx/media2/common/futures/AbstractResolvableFuture$AtomicHelper;->casValue(Landroidx/media2/common/futures/AbstractResolvableFuture;Ljava/lang/Object;Ljava/lang/Object;)Z
...
.method protected setFuture(Lcom/google/common/util/concurrent/ListenableFuture;)Z
    ...
    invoke-virtual {v0, p0, v3, p1}, Landroidx/media2/common/futures/AbstractResolvableFuture$AtomicHelper;->casValue(Landroidx/media2/common/futures/AbstractResolvableFuture;Ljava/lang/Object;Ljava/lang/Object;)Z
    ...
    .line 758
    :cond_1
    new-instance v0, Landroidx/media2/common/futures/AbstractResolvableFuture$SetFuture;

    invoke-direct {v0, p0, p1}, Landroidx/media2/common/futures/AbstractResolvableFuture$SetFuture;-><init>(Landroidx/media2/common/futures/AbstractResolvableFuture;Lcom/google/common/util/concurrent/ListenableFuture;)V

    .line 759
    sget-object v4, Landroidx/media2/common/futures/AbstractResolvableFuture;->ATOMIC_HELPER:Landroidx/media2/common/futures/AbstractResolvableFuture$AtomicHelper;

    invoke-virtual {v4, p0, v3, v0}, Landroidx/media2/common/futures/AbstractResolvableFuture$AtomicHelper;->casValue(Landroidx/media2/common/futures/AbstractResolvableFuture;Ljava/lang/Object;Ljava/lang/Object;)Z
    ...
    invoke-direct {v1, p1}, Landroidx/media2/common/futures/AbstractResolvableFuture$Failure;-><init>(Ljava/lang/Throwable;)V
    :try_end_1
    ...
    .line 774
    :catchall_1
    sget-object v1, Landroidx/media2/common/futures/AbstractResolvableFuture$Failure;->FALLBACK_INSTANCE:Landroidx/media2/common/futures/AbstractResolvableFuture$Failure;

    .line 778
    :goto_0
    sget-object p1, Landroidx/media2/common/futures/AbstractResolvableFuture;->ATOMIC_HELPER:Landroidx/media2/common/futures/AbstractResolvableFuture$AtomicHelper;

    invoke-virtual {p1, p0, v0, v1}, Landroidx/media2/common/futures/AbstractResolvableFuture$AtomicHelper;->casValue(Landroidx/media2/common/futures/AbstractResolvableFuture;Ljava/lang/Object;Ljava/lang/Object;)Z
    ...
    iget-boolean v0, v0, Landroidx/media2/common/futures/AbstractResolvableFuture$Cancellation;->wasInterrupted:Z
